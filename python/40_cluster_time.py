...
cluster_montreal = cluster_montreal[cluster_montreal.kmean_index == 1]
...
monthly_montreal = pd.DataFrame.groupby(cluster_montreal,
                               by=[cluster_montreal.index.year, 
                                   ...
                                   cluster_montreal.kmean_index], sort = True)['kmean_index'].count()
...
x = range(0,len(monthly_montreal_df))
